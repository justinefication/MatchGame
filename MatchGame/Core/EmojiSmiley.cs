 ...
 *
 * File: EmojiSmiley.cs
 * Purpose: An implemention of IEmoji.cs that generates random smiley emoji
 * within the range of \U+1F600 (smile) to \U+1F636 (silence).
 */
...
public class EmojiSmiley : IEmoji
{
    /**
     * A smile emoji.
     */
    private const int LowerBound = 0x1F600;
    
    /**
     * A silence emoji.
     */
    private const int UpperBound = 0x1F636;
